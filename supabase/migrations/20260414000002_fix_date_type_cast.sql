-- ============================================================
-- FIX 2: Explicitly cast ist_current_date() to text
-- The 'booking_date' column is text, not a date. PG errors: "text = date"
-- RUN THIS IN SUPABASE SQL EDITOR!
-- ============================================================

DROP FUNCTION IF EXISTS public.call_next_patient(text);
...
BEGIN
  ...
  WHERE doctor_id    = p_doctor_id
    AND booking_date = public.ist_current_date()::text
